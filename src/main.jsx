...
import { currentRoute, loadPrivacyPage, loadServicePage, loadServicesHub, rootPrefix } from './lib/routes.js'
...
const SUB_PAGE_CHUNKS = {
  service: loadServicePage,
  privacy: loadPrivacyPage,
  servicesHub: loadServicesHub,
}
const subPageChunk = SUB_PAGE_CHUNKS[routeName] || null
if (subPageChunk) {
  subPageChunk()
    .then(boot)
    .catch((error) => {
